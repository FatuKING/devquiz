      ...
      <main className='flex flex-col gap-10 w-full h-full bg-light-background dark:bg-dark-background'>
        ...
        <section className='flex justify-center items-center w-full 2xl:pt-10'>
          <div className='flex gap-10 w-11/12'>
            <article className='flex flex-col gap-2 dark:text-dark-text text-light-text w-1/3'>
              ...
              <table className='flex flex-col w-full h-[400px] 2xl:h-[600px] bg-light-bgSecondary dark:bg-dark-bgSecondary rounded-xl'>
                <thead>
            ...
            <div className='grid grid-cols-3 gap-4'>
              <div className='pt-2 w-full bg-light-bgSecondary dark:bg-dark-bgSecondary rounded-xl'>
              ...
              <div className='pt-2 w-full bg-light-bgSecondary dark:bg-dark-bgSecondary text-light-title dark:text-dark-title rounded-xl'>
