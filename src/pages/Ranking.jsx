          ...
          <div className='flex gap-20 w-11/12'>
            <article className='flex flex-col gap-2 dark:text-dark-text text-light-text w-1/2'>
              <div className='flex justify-between'>
                ...
                <select className='p-1 px-2 text-base 2xl:text-xl text-light-buttonText bg-light-button dark:text-dark-buttonText dark:bg-dark-button rounded-lg' onChange={(e) => dispatch({ type: 'changeCategory', payload: e.target.value })} name='category'>
            ...
            <article className='flex flex-col gap-2 w-1/2'>
              ...
              <div className='pt-2 px-3 w-full bg-light-bgSecondary dark:bg-dark-bgSecondary rounded'>
                <h2 className='font-medium text-lg 2xl:text-xl px-3'>Ciencia de datos</h2>
                <table className='w-full '>
                  <thead>
                    <tr className='flex justify-between text-base 2xl:text-lg text-light-title dark:text-dark-title px-3'>
                      <th>N°</th>
                      <th>Usuarios</th>
                      <th>Puntos</th>
                    </tr>
              ...
              <div className='pt-2 px-3 w-full bg-light-bgSecondary dark:bg-dark-bgSecondary rounded'>
                <h2 className='font-medium text-lg 2xl:text-xl px-3'>Diseño web</h2>
                <table className='w-full'>
                  <thead>
                    <tr className='flex justify-between text-base 2xl:text-lg text-light-title dark:text-dark-title px-3'>
                      <th>N°</th>
              ...
              <div className='pt-2 px-3 w-full bg-light-bgSecondary dark:bg-dark-bgSecondary rounded'>
                <h2 className='font-medium text-lg 2xl:text-xl px-3'>Programación</h2>
                <table className='w-full'>
                  <thead>
                    <tr className='flex justify-between text-base 2xl:text-lg text-light-title dark:text-dark-title px-3'>
                      <th>N°</th>
