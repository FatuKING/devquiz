        ...
        <form action='' className='flex flex-col gap-4 text-light-text dark:text-dark-text w-11/12 sm:w-4/5 md:w-1/2 xl:w-2/5 2xl:w-1/3'>
          <div className='flex flex-col gap-4 md:text-xl text-light-title dark:text-dark-title font-medium'>
            <label className='flex flex-col gap-2' htmlFor=''>
              <input className='p-2 rounded dark:text-dark-text text-light-text bg-white/30 dark:bg-dark-card focus:outline-none shadow-sm shadow-light-button dark:shadow-dark-button' placeholder='Nombre completo' type='text' />
            </label>

            <label className='flex flex-col gap-2' htmlFor=''>
              <input className='p-2 rounded dark:text-dark-text text-light-text bg-white/30 dark:bg-dark-card focus:outline-none shadow-sm shadow-light-button dark:shadow-dark-button' placeholder='Email' type='text' />
            </label>
          </div>
          ...
          <label className='flex flex-col gap-2 lg:text-lg md:text-xl rounded text-light-title dark:text-dark-title font-medium' htmlFor=''>
            <textarea className='h-32 rounded p-2 dark:text-dark-text text-light-text bg-white/30 dark:bg-dark-card focus:outline-none shadow-sm shadow-light-button dark:shadow-dark-button' id='message' placeholder='Mensaje' />
          </label>
